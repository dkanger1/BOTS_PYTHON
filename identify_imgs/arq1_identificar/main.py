...
haystack_img = cv.imread('status.jpg', cv.IMREAD_UNCHANGED)
needle_img = cv.imread('cinco.jpg', cv.IMREAD_UNCHANGED)
...
result = cv.matchTemplate(haystack_img, needle_img, cv.TM_CCOEFF)
